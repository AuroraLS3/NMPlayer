/*
 * https://github.com/freecode/YouTube-Downloader/tree/master/src
 */
package com.djrapitops.nmplayer.fileutils.downloading;

import com.djrapitops.nmplayer.fileutils.ErrorManager;
import java.io.*;
import java.net.*;
import java.util.*;
...
public class YoutubeMp3Downloader {
    ...
    public static void setProgress(Progress progress) {
        YoutubeMp3Downloader.progress = progress;
    }
...
//        });
    ...
    public static String decode(String s) {
        try {
            ...
            ErrorManager.toLog("com.djrapitops.fileutils.downloading.YoutubeMp3Downloader", e);
        }
        return s;
    }
